// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BookmakerIntegrationException.cs" company="HumbleBets">
//     Copyright (c) HumbleBets. All rights reserved.
// </copyright>
// <summary>
// BookmakerIntegrationException
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace TeamService.Domain.Exceptions
{
    using System;
    ...
    public class TeamServiceException : Exception
    {
        ...
        public TeamServiceException(int errorCode)
            : base()
        {
        ...
        /// <param name="errorCode">The error code.</param>
        public TeamServiceException(string message, int errorCode)
            : base(message)
        {
            this.errorCode = errorCode;
        }
        ...
        /// <param name="errorCode">The error code.</param>
        public TeamServiceException(SerializationInfo info, StreamingContext context, int errorCode)
            : this(info, context)
        {
            this.errorCode = errorCode;
        }
        ...
        /// </param>
        protected TeamServiceException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
